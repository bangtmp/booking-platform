...
export const DEMO_SERVICES: DemoService[] = [
  { id: 's1', tenantId: DEMO_TENANT.id, name: 'C?t tóc nam', price: 120000, durationMin: 45, isActive: true },
  { id: 's2', tenantId: DEMO_TENANT.id, name: 'U?n tóc', price: 500000, durationMin: 120, isActive: true },
  { id: 's3', tenantId: DEMO_TENANT.id, name: 'Nhu?m tóc', price: 600000, durationMin: 150, isActive: true },
  { id: 's4', tenantId: DEMO_TENANT.id, name: 'Cham sóc da', price: 300000, durationMin: 60, isActive: true },
];
