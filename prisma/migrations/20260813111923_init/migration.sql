...
-- CreateEnum
CREATE TYPE "TenantBusinessType" AS ENUM ('SALON', 'SPA', 'CLINIC', 'OTHER');

-- CreateEnum
CREATE TYPE "ConfirmMode" AS ENUM ('AUTO', 'MANUAL');
...
CREATE TABLE "Tenant" (
    ...
    "slug" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "businessType" "TenantBusinessType" NOT NULL,
    "confirmMode" "ConfirmMode" NOT NULL DEFAULT 'AUTO',
...
-- CreateIndex
CREATE INDEX "Schedule_tenantId_staffId_idx" ON "Schedule"("tenantId", "staffId");
